            ...
            <div class="row">
                <div class="col-12">
                    <header class="entry-header">
                        <h1 class="entry-title">Felicific 2K19</h1>
                    </header>
                </div>
            </div>
        </div>
            ...
            <div class="event-content-wrap">
                <header class="entry-header flex flex-wrap justify-content-between align-items-end">
                    <div class="single-event-heading">
                        <h2 class="entry-title">Felicific 19</h2>

                        <div class="event-location"><a href="#">DDIT Nadiad</a></div>

                        <div class="event-date">Feb 20, 2019 @ 8:00 Am - Feb 24, 2019 @ 4:00 Pm</div>
                    </div>
                ...
                <figure class="events-thumbnail">
                    <img src="images/felicificmain.jpg" alt="">
                </figure>
            </div>
        </div>
    </div>
            ...
            <div class="tabs">
                ...
                <div class="tabs-container">
                    ...
                    <div id="tab_venue" class="tab-content">
                        <p>D D Institute Of Technology, College Road, Nadiad, Gujarat 388120</p>
                    </div>

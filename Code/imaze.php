            ...
            <div class="row">
                <div class="col-12">
                    <header class="entry-header">
                        <h1 class="entry-title">Imaze 2K19</h1>
                    </header>
                </div>
            </div>
        </div>
            ...
            <div class="event-content-wrap">
                <header class="entry-header flex flex-wrap justify-content-between align-items-end">
                    <div class="single-event-heading">
                        <h2 class="entry-title">Imaze 19</h2>

                        <div class="event-location"><a href="#">GCET Vallabh Vidhyanagar </a></div>

                        <div class="event-date">May 29, 2019 @ 8:00 Am - May 30, 2019 @ 4:00 Pm</div>
                    </div>
                ...
                <figure class="events-thumbnail">
                    <img src="images/imazemain.jpg" alt="">
                </figure>
            </div>
        </div>
    </div>
                    ...
                    <div id="tab_details" class="tab-content">
                        <div class="flex flex-wrap justify-content-between">
                            ...
                            <div class="single-event-map">
                                <iframe id="gmap_canvas" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5965.777448323948!2d72.916928432975!3d22.559782542498088!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e4e1285d628d5%3A0xe6cee346bfaa35d0!2sG+H+Patel+College+of+Engineering+%26+Technology!5e0!3m2!1sen!2sin!4v1552366025946"></iframe>
                            </div>
                        </div>
                    </div>

                    <div id="tab_venue" class="tab-content">
                        <p>G H Patel Institute Of Technology, Vallabh Vidyanagar, Anand, Gujarat 388120</p>
                    </div>
            ...
            <div class="event-tickets">
                <div class="ticket-row flex flex-wrap justify-content-between align-items-center">
                    <div class="ticket-type flex justify-content-between align-items-center">
                        <h3 class="entry-title"><span>Chemomavericks</span> Chemical engg.</h3>
                ...
                <div class="ticket-row flex flex-wrap justify-content-between align-items-center">
                    <div class="ticket-type flex justify-content-between align-items-center">
                        <h3 class="entry-title"><span>Digienchanters</span>Computer engg.</h3>
                    ...
                    <input type="submit" class="btn gradient-bg" value="Buy Ticket">
                     ...
                     <div class="ticket-row flex flex-wrap justify-content-between align-items-center">
                    <div class="ticket-type flex justify-content-between align-items-center">
                        <h3 class="entry-title"><span>Circuityrants</span> Electronic & Communication engg.</h3>
                 ...
                 <div class="ticket-row flex flex-wrap justify-content-between align-items-center">
                    <div class="ticket-type flex justify-content-between align-items-center">
                        <h3 class="entry-title"><span>Concrete Chiefs</span> Civil engg.</h3>

                        <div class="ticket-price">₹139</div>
                    </div>

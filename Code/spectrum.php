            ...
            <div class="row">
                <div class="col-12">
                    <header class="entry-header">
                        <h1 class="entry-title">Spectrum 2K19</h1>
                    </header>
                </div>
            </div>
        </div>
            ...
            <div class="event-content-wrap">
                <header class="entry-header flex flex-wrap justify-content-between align-items-end">
                    <div class="single-event-heading">
                        <h2 class="entry-title">Spectrum 19</h2>

                        <div class="event-location"><a href="#">ADIT Vallabh Vidhyanagar </a></div>

                        <div class="event-date">March 21, 2019 @ 8:00 Am - March 14, 2019 @ 4:00 Pm</div>
                    </div>
                ...
                <figure class="events-thumbnail">
                    <img src="images/spectrummain.jpg" alt="">
                </figure>
            </div>
        </div>
    </div>
                        ...
                        <div class="flex flex-wrap justify-content-between">
                            <div class="single-event-details">
                                <div class="single-event-details-row">
                                    <label>Start:</label>
                                    <p>March 21 @ 09:00 am</p>
                                </div>

                                <div class="single-event-details-row">
                                    <label>End:</label>
                                    <p>March 24 @ 04:00 Pm</p>
                                </div>
                            ...
                            <div class="single-event-map">
                                <iframe id="gmap_canvas" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14742.147157904154!2d72.9164636!3d22.5215561!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xadbe2043bbfd455b!2sA.+D.+Patel+Institute+of+Technology!5e0!3m2!1sen!2sin!4v1552365566045"></iframe>
                            </div>
                        </div>
                    </div>

                    <div id="tab_venue" class="tab-content">
                        <p>A D Patel Institute Of Technology, Vallabh Vidyanagar, Anand, Gujarat 388120</p>
                    </div>
            ...
            <div class="event-tickets">
                <div class="ticket-row flex flex-wrap justify-content-between align-items-center">
                    <div class="ticket-type flex justify-content-between align-items-center">
                        <h3 class="entry-title"><span>Autozinios</span> Automobile engg.</h3>
                ...
                <div class="ticket-row flex flex-wrap justify-content-between align-items-center">
                    <div class="ticket-type flex justify-content-between align-items-center">
                        <h3 class="entry-title"><span>Eclectika</span>Electrical engg.</h3>

                        <div class="ticket-price">₹79</div>
                    </div>
                    ...
                    <input type="submit" class="btn gradient-bg" value="Buy Ticket">
                     ...
                     <div class="ticket-row flex flex-wrap justify-content-between align-items-center">
                    <div class="ticket-type flex justify-content-between align-items-center">
                        <h3 class="entry-title"><span>Incognito</span> Computer engg.</h3>
                 ...
                 <div class="ticket-row flex flex-wrap justify-content-between align-items-center">
                    <div class="ticket-type flex justify-content-between align-items-center">
                        <h3 class="entry-title"><span>Sthapatya</span> Civil engg.</h3>

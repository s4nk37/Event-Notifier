<?php
 ...
 $result = mysqli_query($link, "SELECT * FROM eventlist WHERE em_id = '$em_id'");

  $sql = "select COUNT(e_id) from eventlist WHERE em_id = '$em_id'";
...
<html lang="en">
	...
	<body class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
				...
				<div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-dark ">
					...
					<div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark " m-menu-vertical="1" m-menu-scrollable="1" m-menu-dropdown-timeout="500" style="position: relative;">
						<ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
							...
							<li class="m-menu__item  m-menu__item--active" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="edata.php" class="m-menu__link m-menu__toggle">
        ...
        while($res = mysqli_fetch_array($result)) {   
            ...
            echo "<td>".$res['e_description']."</td>";
            echo "<td>".$res['e_startdate']."</td>";
            echo "<td>".$res['e_enddate']."</td>";
            echo "<td>".$res['e_reg_startdate']."</td>";
            echo "<td>".$res['e_reg_lastdate']."</td>";
            echo "<td>".$res['e_link']."</td>";
            echo"<td>
					<span style='overflow: visible; position: relative; width: 110px;'>											
						<a href=\"delete_event.php?e_id=$res[e_id]\" onClick=\"return confirm('Are you sure you want to delete?')\" class='m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill' title='Delete'><i class='la la-trash'></i></a>
					</span>
				</td>";    
      //       echo"<td>
						// <span style='overflow: visible; position: relative; width: 110px;'>											

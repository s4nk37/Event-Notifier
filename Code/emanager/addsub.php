...
if(!isset($_SESSION['em_id'])){
 ...
 $q2 = mysqli_query($link, "SELECT * FROM eventlist WHERE em_id = '$em_id'");
...
if(isset($_POST['submit'])){
	...
	$sub_time=$_REQUEST['sub_time'];
	$sub_price=$_REQUEST['sub_price'];
	$sub_points=$_REQUEST['sub_points'];
	$sub_venue=$_REQUEST['sub_venue'];
	$sub_type=$_REQUEST['sub_type'];
	$sub_totalentry=$_REQUEST['sub_totalentry'];

	$q3="insert into subevent (e_id,sub_name,sub_description,sub_date,sub_time,sub_price,sub_points,sub_venue,sub_type,sub_totalentry) values ('$e_id','$sub_name','$sub_description','$sub_date','$sub_time','$sub_price','$sub_points','$sub_venue','$sub_type','$sub_totalentry')";
    $e3=$link->query($q3);
...
<html lang="en">
	...
	<body class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
		...
		<div class="m-grid m-grid--hor m-grid--root m-page">
				...
				<div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-dark ">
					...
					<div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark " m-menu-vertical="1" m-menu-scrollable="1" m-menu-dropdown-timeout="500" style="position: relative;">
						<ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
							...
							<li class="m-menu__item  m-menu__item--active" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="addsub.php" class="m-menu__link m-menu__toggle">
									<i class="m-menu__link-icon flaticon-plus"></i>
			...
			<!--begin::Section-->
		<form class="m-form" style="margin-right: 20px;margin-top: 20px; padding-left: 300px; width: 70%;" method="post">
		<div class="m-portlet__body">
			<div class="m-form__section m-form__section--first">
				<div class="form-group m-form__group">
					<label for="example_input_full_name">Event Name:</label>
					<select class="form-control m-input" id="exampleSelect1" name='e_id'>
						<option disabled>Select Event</option>
						<?php  
       					 while($res1 = mysqli_fetch_array($q2)) { 
       					 	echo "<option value=".$res1['e_id'].">".$res1['e_name']."</option>";
							}
						?>
					</select>
				</div>
				<div class="form-group m-form__group">
					<label for="example_input_full_name">Subevent Name:</label>
					<input type="text" class="form-control m-input" placeholder="Enter Event name" name="sub_name" required="">
					<!-- <span class="m-form__help">Please enter your full college name</span> -->
				</div>
				<div class="form-group m-form__group">
					<label for="exampleTextarea">Subevent Description</label>
					<textarea class="form-control m-input" id="exampleTextarea" rows="3" name="sub_description" required=""></textarea>
				</div>
				<div class="form-group m-form__group">
					<label>Subevent Date:</label>
					<input type="date" class="form-control m-input" placeholder="Enter Subevent Date" name="sub_date"  min="<?php
         echo date('Y-m-d');
     ?>" required="">
					<!-- <span class="m-form__help">We'll never share your email with anyone else</span> -->
				</div>
				<div class="form-group m-form__group">
					<label>Subevent Time:</label>
					<input type="time" class="form-control m-input" placeholder="Enter Subevent Time" name="sub_time" required="">
					<!-- <span class="m-form__help">We'll never share your email with anyone else</span> -->
				</div>
				<div class="form-group m-form__group">
					<label>Subevent Price:</label>
					<input type="number" class="form-control m-input" placeholder="Enter Subevent Price" name="sub_price" required="">
					<!-- <span class="m-form__help">We'll never share your email with anyone else</span> -->
				</div>
				<div class="form-group m-form__group">
					<label>Subevent Points:</label>
					<input type="number" class="form-control m-input" placeholder="Enter Subevent Points" name="sub_points" required="">
					<!-- <span class="m-form__help">We'll never share your email with anyone else</span> -->
				</div>
				<div class="form-group m-form__group">
					<label>Subevent Venue:</label>
					<input type="text" class="form-control m-input" placeholder="Enter Subevent Venue" name="sub_venue" required="">
					<!-- <span class="m-form__help">Please enter your full college name</span> -->
				</div>
				<div class="form-group m-form__group">
					<label>Subevent Type:</label>
					<input type="text" class="form-control m-input" placeholder="Enter Subevent Type" name="sub_type" required="">
					<!-- <span class="m-form__help">Please enter your full college name</span> -->
				</div>
				<div class="form-group m-form__group">
					<label>Subevent Total Entries:</label>
					<input type="number" class="form-control m-input" placeholder="Enter Subevent Total Entries" name="sub_totalentry" required="">
					<!-- <span class="m-form__help">Please enter your full college name</span> -->
				</div>
				<!-- <div class="form-group m-form__group">

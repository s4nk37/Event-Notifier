<?php
 ...
 // $w= mysqli_query($link, "SELECT * FROM eventlist INNER JOIN subevent ON subevent.em_id=eventlist.em_id where eventlist.em_id='$em_id' ")
 $result = mysqli_query($link, "SELECT * FROM `participants` INNER JOIN  subevent ON subevent.sub_id = participants.sub_id INNER JOIN eventlist ON eventlist.e_id = subevent.e_id INNER JOIN users ON users.u_id = participants.u_id WHERE eventlist.em_id='$em_id' ");

 
  $result5 = mysqli_query($link, "SELECT * FROM eventlist WHERE em_id = '$em_id'");

 $sql = "select COUNT(p_id) from participants INNER JOIN  subevent ON subevent.sub_id = participants.sub_id INNER JOIN eventlist ON eventlist.e_id = subevent.e_id  WHERE eventlist.em_id='$em_id'";
				...
				<div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-dark ">
					...
					<div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark " m-menu-vertical="1" m-menu-scrollable="1" m-menu-dropdown-timeout="500" style="position: relative;">
						<ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
							...
							<li class="m-menu__item  m-menu__item--active" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="participantinfo.php" class="m-menu__link m-menu__toggle">
							...
							<form method="post">
								<div class="row">
									<div class="form-group m-form__group" style="width: 200px; padding-top: 12px;">
										<select class="form-control m-input" id="event-list" required>
									...
									<div class="form-group m-form__group" style="width: 200px; padding-left: 30px; padding-top: 12px;">
										<select class="form-control m-input" id="subevent-list" name='subi_id' required>
											<option disabled selected>Select Subevent</option>
									...
									<h3 class="m-portlet__head-text" style="padding-left: 326px;">
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<?php 
								        ...
								        $i=$_POST['subi_id'];
								        $result4 = mysqli_query($link, "SELECT * FROM `participants` INNER JOIN  subevent ON subevent.sub_id = participants.sub_id INNER JOIN eventlist ON eventlist.e_id = subevent.e_id INNER JOIN users ON users.u_id = participants.u_id WHERE eventlist.em_id='$em_id' AND participants.sub_id='$i'");
								         $result3 = mysqli_query($link, "SELECT COUNT(p_id) FROM `participants` INNER JOIN  subevent ON subevent.sub_id = participants.sub_id INNER JOIN eventlist ON eventlist.e_id = subevent.e_id INNER JOIN users ON users.u_id = participants.u_id WHERE eventlist.em_id='$em_id' AND participants.sub_id='$i'");
...
if(isset($_POST['submit'])){
		        while($res2 = mysqli_fetch_array($result4)) {   
		        	echo "<tr>";   
		        	echo "<td>".$res2['p_id']."</td>";
...
$('#event-list').on('change', function(){
    ...
    var e_id = $( "#event-list option:selected" ).attr("value"); // inshalla should work

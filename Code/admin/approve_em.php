...
$result = mysqli_query($link,"INSERT INTO eventmanager (`c_name`, `c_city`, `em_name`, `em_password`, `em_cno`, `em_email` ,`em_imagepath`)
SELECT `c_name`, `c_city`, `em_name`, `em_password`, `em_cno`, `em_email`,`em_imagepath`

...
<html lang="en">
	...
	<body class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
				...
				<div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-dark ">
					...
					<div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark " m-menu-vertical="1" m-menu-scrollable="1" m-menu-dropdown-timeout="500" style="position: relative;">
						<ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
							...
							<li class="m-menu__item  m-menu__item--active" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="emapproval.php" class="m-menu__link m-menu__toggle">
									<i class="m-menu__link-icon flaticon-layers"></i>
			...
			<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
				...
				<tbody>
						...
						<span style="overflow: visible; position: relative; width: 110px;">											
							<a href="#" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Approve"><i class="la la-check-circle"></i></a>
        ...
        while($res = mysqli_fetch_array($result)) {  
            ...
            echo"<td>
						<span style='overflow: visible; position: relative; width: 110px;'>											
							<a href=\"approve_em.php?em_tmpid=$res[em_tmpid]\" class='m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill' title='Approve'><i class='la la-check-circle'></i></a>
							<a href=\"delete_emtmp.php?em_tmpid=$res[em_tmpid]\" onClick=\"return confirm('Are you sure you want to delete?')\" class='m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill' title='Delete'><i class='la la-trash'></i></a>
						</span>
						</td>";    
			echo"</tr>";
			}
